    ...
    while wait(.8) do
        pcall(function()
            if _G.Normal_Fast_Attack and _G.AutoFarmLevel or _G.AutoFarmBone then
                repeat wait(.3)
                    AttackNoCD()
                until _G.Normal_Fast_Attack == false
            end
        end)
    end
end)
	...
	game:GetService("RunService").Heartbeat:Connect(function() CheckQuest()
		pcall(function()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.AutoFarmLevel and not _G.BringMonSky and v.Name == Mon and (v.HumanoidRootPart.Position - PosMon.Position).magnitude <= 150 then
                ...
                elseif _G.AutoFarmLevel and W and _G.BringMonSky and v.Name == Mon and (v.HumanoidRootPart.Position - PosMon.Position).magnitude <= 400 then
...
spawn(function()
	while wait() do
		pcall(function()
			...
			if _G.SelectWeaponType == "Sword" then
				for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
			...
			if _G.SelectWeaponType == "Gun" then
				for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
			...
			if _G.SelectWeaponType == "Blox Fruit" then
				for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
...
spawn(function()
    while wait() do
        if _G.Normal_Fast_Attack and _G.AutoFarmLevel then
            pcall(function()
		...
		if _G.AutoFarmLevel then
            pcall(function()
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    CheckQuest()
                    repeat wait() topos(CFrameQuest) until (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or not _G.AutoFarmLevel
...
spawn(function()
    pcall(function()
        game:GetService("RunService").Stepped:Connect(function()
            if _G.AutoFarmLevel or _G.AutoFarmBone then
